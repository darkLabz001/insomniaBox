...
def _show_lock_wake_screen(reason: str = "Locked") -> None:
    try:
        ...
        lock_icon_font = ImageFont.truetype('/usr/share/fonts/truetype/font-awesome/fontawesome-webfont.ttf', S(28))
...
def _draw_lock_screensaver_frame(frame: Image.Image) -> None:
    try:
        ...
        image.paste(frame)
        lock_icon = MENU_ICONS.get(" Lock", "\uf023")
        lock_icon_font = ImageFont.truetype('/usr/share/fonts/truetype/font-awesome/fontawesome-webfont.ttf', S(14))
...
def RenderMenuCarouselOnce(inlist, selected_index=0):
    ...
    try:
        ...
        huge_icon_font = ImageFont.truetype('/usr/share/fonts/truetype/font-awesome/fontawesome-webfont.ttf', S(48))
...
icon_font = ImageFont.truetype('/usr/share/fonts/truetype/font-awesome/fontawesome-webfont.ttf', S(13))
